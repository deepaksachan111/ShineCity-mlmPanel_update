...
import com.example.deepaksachan.shinecity_mlmpanel.Model.PayoutDetailData;
        ...
        private void displayagentrecord(String response) {
            ...
            try {
                ...
                for (int i = 0; i < jArray.length(); i++) {
                    ...
                    long s = sum;
                    payoutDetailData.add(new PayoutDetailData(date, payoutdetail, harmonyallot, hormony, selfincentive, tds, grassamount, process, netamt));
