...
import com.example.deepaksachan.shinecity_mlmpanel.Model.AgentPlotReportData;
...
public class AgentPlotReportDisplayFragment extends Fragment {
     ...
     private ArrayList<AgentPlotReportData> ajentplotreportdata;
     private ArrayAdapter<AgentPlotReportData> agentPlotReportDataArrayAdapter;
    ...
    private class AgentPlotRecordDisplayAsyncTask extends AsyncTask<String, Void, String> {
        ...
        private void displayagentrecord(String response) {
            ajentplotreportdata = new ArrayList<AgentPlotReportData>();
            try {
                ...
                for (int i = 0; i < jArray.length(); i++) {
                    ...
                    ajentplotreportdata.add(new AgentPlotReportData(plotholder, member, depoby, plotno, receipt, mode, pmttype,amount,status));
    ...
    private class AgentPlotReportArrayAdapter extends ArrayAdapter<AgentPlotReportData> {
        ...
        private ArrayList<AgentPlotReportData> agentPlotReportDatas;
        private Context context;
        // private TextView Date,Month,Year,Amount;


        public AgentPlotReportArrayAdapter(Context context, int resource, ArrayList<AgentPlotReportData> agentPlotReportDatas) {
          ...
          /*  ViewHolder holder = null;
            ...
            //    holder.recepit = (TextView) convertView.findViewById(R.id.tv_agent_receipt);
             ...
             //   holder.mode = (TextView) convertView.findViewById(R.id.tv_agent_mode);
                ...
                AgentPlotReportData data = agentPlotReportDatas.get(position);
