package com.example.deepaksachan.shinecity_mlmpanel;
...
import com.example.deepaksachan.shinecity_mlmpanel.Model.DownlineRecordData;
...
public class HomeActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            getFragmentManager().beginTransaction().replace(R.id.mainContent, new ProfileFragment()).commit();
    ...
    public void onClick(View v) {
        ...
        if (v == linearLayoutProfile) {
            ...
            expand_layout.setVisibility(View.GONE);
            flag = true;
            getFragmentManager().beginTransaction().replace(R.id.mainContent, new ChangePasswordFragment()).commit();
            ...
            ListviewHelper.getListViewSize(myreports_explistview);
    ...
    private void sublistdata(int position) {
        ...
        switch (id) {
            case 0:
                ...
                flag = true;
                mDrawerLayout.closeDrawer(mDrawerPane);
                getFragmentManager().beginTransaction().replace(R.id.mainContent, new BusinessStatisticsFragment()).commit();
            ...
            case 2:
               ...
               // getSupportActionBar().setTitle("E-Pin Registration");
                ...
                mDrawerLayout.closeDrawer(mDrawerPane);
                // getFragmentManager().beginTransaction().replace(R.id.mainContent, new EPinListFragment()).commit();
                startActivity(new Intent(this, EPinRegistrationActivity.class));
                break;
            case 3:
                ...
                flag = true;
                mDrawerLayout.closeDrawer(mDrawerPane);
                getFragmentManager().beginTransaction().replace(R.id.mainContent, new BusinessReportFragment()).commit();
                break;
            ...
            case 4:
                ...
                flag = true;
                mDrawerLayout.closeDrawer(mDrawerPane);
                getFragmentManager().beginTransaction().replace(R.id.mainContent, new HarmonyInsentiveDisplayFragment()).commit();
                break;
            ...
            case 5:
                ...
                flag = true;
                mDrawerLayout.closeDrawer(mDrawerPane);
                getFragmentManager().beginTransaction().replace(R.id.mainContent, new SelfIncentiveDisplayFragment()).commit();
                break;
            case 6:
                ...
                flag = true;
                mDrawerLayout.closeDrawer(mDrawerPane);
                getFragmentManager().beginTransaction().replace(R.id.mainContent, new AgentPlotReportFragment()).commit();
                break;
            case 7:
                ...
                flag = true;
                mDrawerLayout.closeDrawer(mDrawerPane);
                getFragmentManager().beginTransaction().replace(R.id.mainContent, new PayoutReportDisplayFragment()).commit();
                break;
            case 8:
                ...
                flag = true;
                mDrawerLayout.closeDrawer(mDrawerPane);
                getFragmentManager().beginTransaction().replace(R.id.mainContent, new DownlineReportFragment()).commit();
                break;
