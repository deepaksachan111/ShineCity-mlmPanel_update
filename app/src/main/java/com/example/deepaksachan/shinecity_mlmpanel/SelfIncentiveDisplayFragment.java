...
import com.example.deepaksachan.shinecity_mlmpanel.Model.BusinessData.SelfIncentiveAdapterdata;
...
public class SelfIncentiveDisplayFragment extends Fragment {
    private ArrayAdapter<SelfIncentiveAdapterdata> selfIncentiveAdapterdataArrayAdapter;
